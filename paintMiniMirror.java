    ...
    public void paint(Graphics g) 
    {
        ...
        switch (mode) 
        {
            ...
            case 2:
                ...
                g.drawLine((int)(0.20 * getWidth()), (int)(0.29 * getHeight()), (int)(0.66 * getWidth()), (int)(0.64 * getHeight()));
            ...
            case 3:
                g.drawRect((int)(0.17 * getWidth()), (int)(0.11 * getHeight()), (int)(0.61 * getWidth()), (int)(0.53 * getHeight()));

                break;

            case 4:
                g.drawOval((int)(0.20 * getWidth()), (int)(0.12 * getHeight()), (int)(0.50 * getWidth()), (int)(0.59 * getHeight()));
            ...
            case 5:
                ...
                p.addPoint((int)(0.33 * getWidth()), (int)(0.11 * getHeight()));
                p.addPoint((int)(0.62 * getWidth()), (int)(0.11 * getHeight()));
                p.addPoint((int)(0.20 * getWidth()), (int)(0.88 * getHeight()));
            ...
            case 6:
                ...
                g.fillRect((int)(0.17 * getWidth()), (int)(0.11 * getHeight()), (int)(0.61 * getWidth()), (int)(0.53 * getHeight()));
                break;
        }
        /*
                switch(mode)
...
class PaintingApplication extends Frame implements ActionListener, MouseListener, MouseMotionListener 
{
    ...
    Button blue = new Button(), cyan = new Button(), dark_gray = new Button(),
        ...
        pink = new Button(), red = new Button(), white = new Button(), yellow = new Button(), black = new Button();
...

    {
        ...
        dark_gray.setActionCommand("darkGray");
            ...
            { //System.out.println("Current mode = "+mode);
                switch (mode) 
                {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        break; // was supposed to be polygon feature but was removed
                    case 5:
                        ...
                        } else if (released == true) 
                        {
                            ...
                            {
                                sendNewActivity(act);
                                System.out.println("sent a filled rectangle");
                            }
                        }
                        break;
                }
                ...
                try {
                    ...
                    updationThread = new Thread() 
                    {
                        public void run() {
                            try {
                                while (isOnline)
                                    app.performNewActivity();
                            } 
                            catch (Exception e) 
                            {
                                System.out.println("networking terminated");
                            }
                        }
                    };
    ...
    public void actionPerformed(ActionEvent e) 
    {
        switch (e.getActionCommand()) 
        {
            ...
            case "blue":
                ...
                break;
            case "cyan":
                selectedColor.setBackground(Color.cyan);
                currentColor = Color.cyan;
                break;
            case "darkGray":
                selectedColor.setBackground(Color.darkGray);
            ...
            case "green":
                ...
                break;
            case "lightGray":
                selectedColor.setBackground(Color.lightGray);
            ...
            case "setRadius":
                ...
                break;
            case "configureRadius":
                radiusDialog.show(true);
                break;
            case "saveCancelButton":
                saveDialog.show(false);
                break;
            case "saveButton":
                saveImage(saveText.getText());
                saveDialog.show(false);
                break;
            case "save":
            ...
            case "open":
                ...
                break;
            case "openButton":
                openImage(openText.getText());
                break;
            case "Send":
                mirrorStartDialog.show(true);
                break;
            case "Recieve":
                mirrorStopDialog.show(true);
                break;
            case "Connect":
                /*System.out.println(e.getActionCommand());*/ connectToPartner(); /* System.out.println("done connecting to partner");*/
                break;
            case "Accept Request":
                /*System.out.println(e.getActionCommand());*/ acceptConnectionFromPartner();
                break;
            case "My Address":
                ipInfoDialog.show(true);
                ipInfoText.setText(getIpOfDevice());
                break;
            case "Light Refresh":
                currentActivities.clear();
                break;
